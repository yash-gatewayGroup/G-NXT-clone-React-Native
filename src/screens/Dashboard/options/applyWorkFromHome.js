...
export default function ApplyWorkFromHome() {
    ...
    const handleApplyLeave = () => {
        if (!reasonType || !inDate || !description || !outTime || !inTime) {
    ...
    const ReasonData = [
        { label: 'Medical', value: 'Medical', name: 'Medical' },
        ...
        <>
            ...
            <ScrollView>
                <View style={styles.workFromHomeConatiner}>
                    ...
                    />
                    <View style={styles.timingsMainContainer}>
                        <Text style={styles.shiftText}>Shift Timings: </Text>
                        <Text style={styles.shiftText}> 9:30 to 19:00 </Text>
                    </View>
                    <View style={styles.reasonStyle}>
                        <Text style={styles.reasonTypeText}>Select Reason Type</Text>
                        <Dropdown
                        ...
                        <Text style={styles.entryTimeText}> The entry time should be 24 hrs only</Text>
